...
-------------------------------------------------------------
CREATE SEQUENCE IF NOT EXISTS TECHNICAL.LOG_KEY_SEQ START = 1 INCREMENT = 1 ORDER;
CREATE SEQUENCE IF NOT EXISTS TECHNICAL.EXTRACT_ID_SEQ START = 1 INCREMENT = 1 ORDER;
