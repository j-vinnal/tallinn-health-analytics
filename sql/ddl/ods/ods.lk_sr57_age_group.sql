...
CREATE TABLE IF NOT EXISTS ods.lk_sr57_age_group (
    ...
    CONSTRAINT pk_ods_lk_sr57_age_group PRIMARY KEY (age_group_id),
    CONSTRAINT uk_ods_lk_sr57_age_group UNIQUE (age_group_label)
);
